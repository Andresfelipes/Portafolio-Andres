...
namespace Renta_de_Peliculas.Controllers
{
    public class PeliculasController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "idPelicula,titulo,director,genero")] Peliculas peliculas)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "idPelicula,titulo,director,genero")] Peliculas peliculas)
        {
            if (ModelState.IsValid)
            {
